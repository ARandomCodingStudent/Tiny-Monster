...
function setup () {
    ...
    floor = createSprite (windowWidth/2,windowHeight/2,windowWidth,windowHeight);
    ...
    alien.addAnimation (alienAnimation);
    alien.scale = 0.3
...
function createCupcake() {
    ...
    if (gameState === END) {
        ...
        mouseGroup.setVelocityEach(0);
        breadGroup.setVelocityEach(0);
        cupcakeGroup.setVelocityEach(0);
